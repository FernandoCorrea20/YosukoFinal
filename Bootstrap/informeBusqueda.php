            ...
            <div class="col-sm ">
                ...
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-to">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../bootstrap/busquedaCliente.php#">Volver a Busqueda</a>
                        </li>
                    </ul>
                </nav> 
            </div>
        ...
        <div class="row">
            ...
            <!-- -------------------------------------------------------------------------------------- -->
                        ...
                        <!-- -------------------------------------------------------------------------------------- --> 
                            ...
                            <center><h4 class="font-weight-bold" id="rellenoTitulo" > Resultado de la Búsqueda </h4></center>
                            <table >
                            <tr style="background-color: #eac4a5;font-family: 'Merriweather Sans', sans-serif;text-align: center ;box-shadow: 2px 2px 10px rgb(73, 35, 3);">
                            <td > 
                                <?php
                                ...
                                $busqueda = mysqli_query($bd, "SELECT id_cliente, nombres, apellidos, direccion,dni,compras FROM clientes WHERE apellidos LIKE '$_REQUEST[apellidoClie]%'  ");

                                while ($row = mysqli_fetch_array($busqueda)){


                                    echo  "<center><option>" ."<br>". "Clave: " .$row
                                    ['id_cliente'] ."<br>"."Nombre y Apellido: ".$row['nombres'] ." ". $row['apellidos'] ."<br>"."Dirección: ".$row['direccion']."<br>"."DNI: " .$row['dni']."<br>"."Compras: " .$row['compras']. "</option></center>". "<br>" ;
                                    
                                    if($row['compras']==10)
                                    {
                                        echo "<font color='green'><strong>YA TIENE UN DESCUENTO DEL 30% EN LA PROXIMA COMPRA</strong></font>";
 
                                    }else
                                    {
                                        echo "<font color='red'><u><strong>NO TIENE DISPONIBLE NINGUNA PROMOCION</strong></u></font> ";
