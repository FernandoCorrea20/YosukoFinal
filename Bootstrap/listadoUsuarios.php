...
<body  id="cuerpo">
    ...
    <center><div class="container-fluid  w-75 ">
        ...
        <div class="row">
            <div class="col-1" id="rellenoGrid" >

            <br>
                <form action="buscarCatUsuario.php" method="post">
                <h6><b>Filtrar por Cargo</b> </h6>
            ...
            <div class="col-10 " id="rellenoGrid" > <!-- segunda columna del body -->
                <!-- -------------------------------------------------------------------------------------- -->

                <center><h4 class="font-weight-bold" id="rellenoTitulo" > Listado de Usuarios </h4></center>
                    ...
                    <?php
                        ...
                        foreach ($usuario as $u) {
                            ...
                            echo "<td>".$u->id."</td>";
                                ...
                                echo "<td>".$u->cargo."</td>";
                                echo "<td>".$u->fechaIngreso."</td>";
                                echo "<td>".$u->estado."</td>";

                                echo "<td>";
                                    echo "<a type='buttom' style='background-color: #0eae24;color:white;text-decoration:none;
                                    padding-top:3px;padding-bottom:3px;padding-left:8px;padding-right:8px;' 
                                    href='../Ajax/cambiarEstadoUsuarioAjax.php?id=".$u->id."'>Cambiar</a>";
                                    echo " ";
                                    echo "<a href='../Ajax/eliminarUsuarioAjax.php?id=".$u->id."' type='button' 
           ...
           <br>
            ...
            <div class="col-1" id="rellenoGrid"></div> <!-- tercer columna del body -->
        </div> 
