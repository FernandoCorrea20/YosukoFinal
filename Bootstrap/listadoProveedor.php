...
<body  id="cuerpo">
    ...
    <center><div class="container-fluid  w-75 ">
        ...
        <div class="row">
            ...
            <br>
            <br>
                <form action="buscarFechaProveedor.php" method="post">
                <h6><b>Filtrar por fecha</b> </h6>
            ...
            <div class="col-10 " id="rellenoGrid" > <!-- segunda columna del body -->
                <!-- -------------------------------------------------------------------------------------- -->
                <br>
                <center><h4 class="font-weight-bold" id="rellenoTitulo" > Listado de Proveedores </h4></center>
                <table class="table-secondary table-bordered table-sm" border="2" style="border-color: black; box-shadow: 2px 2px 10px rgb(73, 35, 3);text-align: center;">
                    ...
                    <?php
                        ...
                        foreach ($proveedor as $p) {
                            ...
                            echo "<td>".$p->id."</td>";
                                echo "<td>".$p->dni."</td>";
                                echo "<td>".$p->razonSocial."</td>";
                                echo "<td>".$p->telefono."</td>";
                                echo "<td>"."<a href='mailto:elcorreoquequieres@correo.com'>".$p->email."</a>"."</td>";
                                echo "<td>".$p->direccion."</td>";
                                echo "<td>".$p->fechaIngreso."</td>";


                                echo "<td>";
                                    echo "<a href='../Ajax/eliminarProveedorAjax.php?id=".$p->id."' type='button' 
