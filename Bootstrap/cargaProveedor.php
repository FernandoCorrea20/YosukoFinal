    ...
    <div class="container-fluid  w-75 ">
        ...
        <div class="row">
            ...
            <!-- -------------------------------------------------------------------------------------- -->
                        ...
                        <form  id="form" action="../Ajax/proveedorAjax.php" class="needs-validation" method="post">

                        <center><h4 class="font-weight-bold" id="rellenoTitulo" > Registro de Proveedor </h4></center>
                        
                        <div  id="formGroup">   
                            <div class="input-group mb-3 input-group-sm" >
                                <input class="form-control" id="input" type="text" class="form-control" placeholder="DNI" name="dni" required>
                                <input class="form-control" id="input" type="text" class="form-control" placeholder="Razon Social" name="razon_social" required>
                            </div>  
                        </div>
                        ...
                        <div  id="formGroup">   
                            <div class="input-group mb-3 input-group-sm" >
                                ...
                                <input class="form-control" id="input" type="text" class="form-control" placeholder="Email" name="correo" required>
                            </div>  
                        </div>
                            <!-- -------------------------------------------------------------------------------------- -->          
                        <div  id="formGroup">   
                            ...
                            <div  id="formGroup">   
                            <div class="input-group mb-3 input-group-sm" >
                                <input class="form-control" id="input" type="hidden" class="form-control" placeholder="Id del Usuario" name="idUsuario" value="1" required>
