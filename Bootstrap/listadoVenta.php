    ...
    <center><div class="container-fluid  w-75 ">
        ...
        <div class="row">
            <div class="col-2" id="rellenoGrid" >
                ...
                <br>
                <form action="buscarFechaVenta.php" method="post">
                        ...
                        foreach ($ventas as $v) {
                            echo "<tr>";
                                ...
                                echo "<td>";
                                    ...
                                    href='../Bootstrap/detalleVentas.php?id=".$v->id."'>Ver detalle</a>";
                                    echo " ";
                                    echo "<a href='../Ajax/anularFactAjax.php?id=".$v->id."' type='button' 
