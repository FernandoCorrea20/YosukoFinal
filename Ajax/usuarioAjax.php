            ...
            <div class="col-sm ">
                ...
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-to">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../bootstrap/cargaUsuario.php#">Volver</a>
                        </li>
                    </ul>
                </nav> 
            </div>
    ...
    <div class="container-fluid  w-75 ">
        ...
        <div class="row">
            ...
            <?php
                    ...
                    //llamar a Usuarios.php
                    require_once("../modulos/moduloUsuario.php");

                    $usuarios = new Usuarios();

                            /* verificamos si existe el dni y correo en la base de datos, si ya existe 
                            un registro con el dni o el correo entonces no se registra el usuario*/

                            $datos = $usuarios -> get_dni_correo_usuario($_POST["dni"],$_POST["email"]);
                            ...
                            if($_POST["contraseña1"] == $_POST["contraseña2"])
                            {
                                ...
                                {
                                    $errors[]="El DNI y el Correo ya existen";
                            ...
                            }else
                            {
                                ...
                                /*Si el password no coincide, entonces se muestra mensaje de error*/ 

                                $errors[]="El password no coincide";
                            }

                            header("location: ../Bootstrap/cargaUsuario.php");
