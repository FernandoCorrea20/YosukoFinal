    ...
    <div class="container-fluid  w-75 ">
        ...
        <div class="row">
            ...
            <?php
                    ...
                    require_once("../modulos/moduloProveedor.php");
                    ...
                    $proveedor = new Proveedor();
                            ...
                            $datos = $proveedor ->  get_datos_proveedor($_POST["dni"],$_POST["razon_social"]);
                            ...
                            //validación de dni
                                ...
                                {
                                    $errors[]="La Razon Social ya existe.";

                                }
                
                                header("location: ../Bootstrap/cargaProveedor.php");
